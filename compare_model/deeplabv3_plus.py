...
from net.deepv3.xception import xception
from net.deepv3.mobilenetv2 import mobilenetv2
...
class InstanceCounter(nn.Module):
    def __init__(self, input_n_filters, out_chs=20):
        ...
        self.cnn = nn.Sequential(nn.MaxPool2d(2,2),
                                 single_conv_relu_batch(self.input_n_filters, self.out_filter, 3, 1, 1),
...
class DeepLab(nn.Module):
    def __init__(self, num_classes, backbone="mobilenet", pretrained=False, downsample_factor=16):
        ...
        self.ins_counter = InstanceCounter(256, out_chs=num_classes)
        self.ins_segHead = instanceSegmenationHead(256, out_chans=num_classes)
        self.sem_segHead = instanceSegmenationHead(256, 2)
    ...
    def forward(self, x):
        ...
        ins = self.ins_segHead(x)
        seg = self.sem_segHead(x)

        return seg, ins, count
