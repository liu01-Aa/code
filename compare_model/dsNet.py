...
import time
from net.dsnet_utils import BasicBlock, Bottleneck, segmenthead,  Muti_AFF, segmenthead_c, SPASPP, MFACB
import logging
import os
...
class DSNet(nn.Module):
    ...
    def __init__(self, m=2, n=3, num_classes=19, planes=64, out_classes=12, name='s128', augment=False):
        super(DSNet, self).__init__()
        self.augment = augment
        self.name = name
        self.final_super_0_4 = feHead(num_classes, out_chs=out_classes)
        # I Branch
    ...
    def forward(self, x):
        ...
        seg_head, ins_head, count = self.final_super_0_4(x_)
