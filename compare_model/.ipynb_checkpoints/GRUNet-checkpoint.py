...
class instanceSegmenationHead(nn.Module):
    def __init__(self, in_chans=54, out_chans=36):
        ...
        # self.ins_conv = nn.Sequential(nn.Conv2d(in_chans, out_chans, 3, 1, 1),
        #                               nn.ReLU(inplace=True),
        #                               nn.BatchNorm2d(out_chans))
        # self.ins_conv = nn.Conv2d(in_chans, out_chans, 3, 1, 1)
...
class Gr_unet(nn.Module):
    def __init__(self,  in_chans=[32, 64, 128, 256, 512], out_chs=16,  out_class=2):
        ...
        self.ins_segHead = instanceSegmenationHead(32, out_chans=out_chs)
        ...
        self.ins_counter = InstanceCounter(32, out_chs=16)
